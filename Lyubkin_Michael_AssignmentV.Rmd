...
After cutting the ,,worng" points, I write the code for map. Almost all lines were already given, I solely added the geom_point() argument with the geospatial information.
...
```{r map_czech_republic, warning=F}
ggplot() + 
  geom_polygon(
        aes(x = long, y = lat, group = group), 
